...
public class ProductController {
    ...
    public ResponseEntity<Void> ajouterProduit(@Valid @RequestBody Product product) {
        ...
        String produitNom = productAdded.getNom();

        if(productAdded.getPrix() <= 0) throw new ProduitGratuitException("Le produit "+produitNom+" ne peux pas être gratuit!");
    ...
    //Récupère tous les produits avec leur marge de prix
    @GetMapping(value ="/AdminProduits")
    public Map<Product, Integer> calculerMargeProduit(){

        List<Product> produits = productDao.findAllByOrderById();
